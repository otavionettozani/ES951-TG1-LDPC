...
#define H_MATRIX_SIZE (68039)

#define DATA_SIZE (0x7e9)

#define COUNTER_SIZE (0x1fa4)
...
typedef enum {
	...
	COMMADDRESS_COUNTER_SIGNAL = COMMADDRESS_DATA + DATA_SIZE + 0x4,
	COMMADDRESS_COUNTER = COMMADDRESS_COUNTER_SIGNAL + DATA_SIZE + 0x4,
